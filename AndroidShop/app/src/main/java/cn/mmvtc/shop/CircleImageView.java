...
//    public CircleImageView(Context context, AttributeSet attrs, Context context1, Context context2) {
...
//    public CircleImageView(Context context, Context context1) {
//        super(context);
